export enum PostHogAction {
  ...
  SettingsCustomBlockfrostClick = 'settings | custom blockfrost api | click',
  SettingsCustomBlockfrostXClick = 'settings | custom blockfrost api | x | click',
  SettingsCustomBlockfrostEnableClick = 'settings | custom blockfrost api | enable | click',
